const CONFIG = {
  ...
  NOTICE_BAR: [
    { title: '欢迎来到我的博客', url: 'https://blog.prosesynth.com/' },
    { title: '访问文档中心获取更多帮助', url: 'https://blog.prosesynth.com/' }
  ],

  // 英雄区(首页顶部大卡)
  HERO_TITLE_1: '分享编程',
  HERO_TITLE_2: '与思维认知',
  HERO_TITLE_3: 'blog.prosesynth.com',
  HERO_TITLE_4: '新版上线',
  HERO_TITLE_5: 'Stellar-dream 轻松定制主题',
  HERO_TITLE_LINK: 'https://stellar-dream.prosesynth.com/',
  ...
  SOCIAL_CARD_URL: 'https://docs.blog.prosesynth.com/article/how-to-question',
