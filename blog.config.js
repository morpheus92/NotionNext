...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '这里只分享基于经验的内容、经过测试的策略和学习驱动的信息',
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '这里只分享基于经验的内容、经过测试的策略和学习驱动的信息', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.prosesynth.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, AI绘画, promot', // 网站关键词 英文逗号隔开
